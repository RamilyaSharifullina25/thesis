...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv1d(self.ndf, self.ndf*2, 4, 2, 1, bias=False),
            nn.LeakyReLU(0.2, inplace=True),
            nn.InstanceNorm2d(self.ndf*2),
            # 64 x 64

            nn.Conv1d(self.ndf*2, self.ndf*4, 4, 2, 1, bias=False),
            nn.LeakyReLU(0.2, inplace=True),
...
class Generator(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv4 = nn.Sequential(
            nn.Conv1d(self.ngf*4, self.ngf*8, 4, 2, 1),
            nn.LeakyReLU(0.2, inplace=True),
            nn.InstanceNorm1d(self.ngf*8)
        )

        self.conv5 = nn.Sequential(
            nn.Conv1d(self.ngf*8, self.ngf*8, 4, 2, 1),
            nn.LeakyReLU(0.2, inplace=True),
            nn.InstanceNorm1d(self.ngf*8)
        )
        ...
        self.deconv1 = nn.Sequential(
            nn.ConvTranspose1d(self.ngf*8, self.ngf*8, 4, 2, 1),
            nn.InstanceNorm1d(self.ngf*8),
            nn.ReLU(inplace=True)
        )

        self.deconv2 = nn.Sequential(
            nn.ConvTranspose1d(self.ngf*16, self.ngf*8, 4, 2, 1),
            nn.InstanceNorm1d(self.ngf*8),
            nn.ReLU(inplace=True)
        )
        ...
        self.deconv5 = nn.Sequential(
            nn.ConvTranspose1d(self.ngf*16, self.ngf*4, 4, 2, 1),
            nn.InstanceNorm1d(self.ngf*4),
            nn.ReLU(inplace=True)
        )
